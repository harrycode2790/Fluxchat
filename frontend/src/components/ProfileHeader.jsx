...
function ProfileHeader() {
  const { logOut, authUser, updateProfilePic, isUpdatingProfile } = useAuthStore();
  ...
  const handleImageUpload = async (e) => {
    ...
    setSelectedImg(URL.createObjectURL(file)); // show preview immediately
    ...
    try {
      ...
      // Optionally update selected image with backend-confirmed URL
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="avatar online">
            ...
            >
              {isUpdatingProfile ? <LoaderIcon className=" size-5 animate-spin" /> :  <img
